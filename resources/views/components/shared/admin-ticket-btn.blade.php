@props(['ticket'])
    <div class="inline-flex items-center rounded-md shadow-sm">
        ...
        <button data-modal-target="authentication-modal-{{ $ticket->id }}" data-modal-toggle="authentication-modal-{{ $ticket->id }}" type="button" class="text-red-600 hover:text-red-800 text-sm bg-white hover:bg-red-200 border border-slate-200 rounded-r-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
            <span >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
