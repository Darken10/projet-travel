            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form method="POST" class="space-y-4" action="{{ route('admin.ticket-validation.valider',$ticket) }}">
                        ...
                        <button type="reset" data-modal-hide="authentication-modal-{{ $ticket->id }}" class="w-1/2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Annuller</button>
