@props(['edite'=>false,'delete'=>false,'view'=>false])
...
<div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow my-10">
    ...
    <div class="inline-flex items-center rounded-md shadow-sm">
        ...
        <button class="bg-red-600 text-slate-800 hover:text-blue-600 text-sm  hover:bg-slate-100 border  border-slate-200 rounded-r-lg rounded-lg gap-2 font-medium px-4 py-2 inline-flex space-x-1 items-center">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
    ...
    <hr class="my-5 border border-slate-100">
    <div class="inline-flex items-center rounded-md shadow-sm">
        <button class="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded-l-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
            <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
