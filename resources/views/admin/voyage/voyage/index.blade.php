...
<div class="w-full mx-auto bg-white shadow-lg rounded-md border border-gray-200 py-4">
    <header class="px-5 py-4 border-b border-gray-100 flex justify-between">
        <h2 class="font-semibold text-gray-800 capitalize flex justify-between items-center">Les Voyages</span> </h2>
                    ...
                    @foreach ($voyages as $voyage)
                        <tr @class([' bg-gray-200'=>$i % 2 == 1 ])>
                            <td class="p-2 whitespace-nowrap">
                                <div>{{ $voyage->course->ligne->depart->name }} ({{ $voyage->course->ligne->depart->pays->name }})</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                                <div>{{ $voyage->course->ligne->destination->name }} ({{ $voyage->course->ligne->destination->pays->name }})</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                            ...
                            <td class="p-2 whitespace-nowrap">
                                <div>{{ $voyage->course->heure_arriver }} </div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
